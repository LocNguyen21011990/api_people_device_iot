...
function deviceAPI(app) {
    ...
    router.post('/createInfoDevice', function(req, res) {
        ...
        devicePersistent.createDevice(id, name, description, imageDevice, type, ipv6,
    ...
    router.post('/updateDevice', function(req, res) {
        ...
        var coordinates = req.body.coordinates;
        var expireddates = req.body.expireddates;
        devicePersistent.updateDevice(id, name, description, imageDevice, ipv6, datemodified, status, type, coordinates, expireddates, dbconnection, function(err, data) {
            res.jsonp(Utilities.apiMessage(err, data));
        });
    });
