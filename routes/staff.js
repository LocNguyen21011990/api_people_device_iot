...
function staffAPI(app) {
    ...
    router.post('/addStaff', function(req, res) {
        ...
        staffPersistent.addStaff(staffId, avatar, title, firstname, lastname, email,
            phonenumber, gender, experience, position, department, bloodtype, diet, adicted, drug, metalemotionhealth, datecreated, training, dbconnection,
            function(err, data) {
    ...
    router.post('/updateStaff/:staffId', function(req, res) {
        ...
        if (req.body.type === 'working') {
            ...
            var position = req.body.position;
            var department = req.body.department;
            staffPersistent.updateStaffWorkingInfo(staffId, experience, position, department, datemodified, dbconnection,
                function(err, data) {
                    res.jsonp(Utilities.apiMessage(err, data));
                });
        }
